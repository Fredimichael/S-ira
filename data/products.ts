...
export const products: Product[] = [
  ...
  //Pulseras
  // { id: 'gd-brace-01', title: 'Pulsera Atenea', price: 7600, category: 'acero-dorado', subcategory: 'pulseras', images:[ '/placeholder/Pulsera_Atenea_D.jpg', description: 'Pulsera de eslabones suaves, resistente al agua.' },
  ...
  // { id: 'sw-brace-01', title: 'Pulsera Atenea', price: 4200, category: 'acero-blanco', subcategory: 'pulseras', images:[ '/placeholder/Pulsera_Atenea2_P.jpg', description: 'Pulsera liviana y resistente al agua.' },
  { id: 'sw-brace-03', title: 'Pulsera Charms', price: 9500, category: 'acero-blanco', subcategory: 'pulseras', images:[ '/placeholder/Pulsera_Charms.jpg','/placeholder/Pulsera_Charms2.jpg',], description: 'Pulsera de acero blanco estilo Pandora. Incluye varios dijes colgantes: una rosa, un moño y un corazón esmaltado en rosa con la inscripción en inglés "HUG ME". La pulsera cuenta con cierre mosquetón y cadena de extensión.' , featured: true ,outOfStock: true} ,
